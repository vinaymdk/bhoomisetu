...
class SellerInterestsScreen extends StatefulWidget {
  ...
  @override
  State<SellerInterestsScreen> createState() => _SellerInterestsScreenState();
}

class _SellerInterestsScreenState extends State<SellerInterestsScreen> {
  final MediationService _service = MediationService();
  List<InterestExpression> _items = [];
  bool _isLoading = true;
  String? _error;
  String _status = '';
  BottomNavItem _currentNavItem = BottomNavItem.list;
  ...
  Future<void> _load() async {
    ...
    try {
      final resp = await _service.getPropertyInterests(status: _status);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Property Interests'),
        ...
        child: ListView(
          ...
          children: [
            ...
            if (_isLoading)
              ...
              _stateCard('No interests yet. We will notify you when buyers express interest.')
            else
